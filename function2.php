...
class function_data {    
    function tambah_data ($tiang, $id_fat, $noport, $id_port, $status){
        ...
        if ($result){
            ...
            echo '</script>';
            echo "<script>setTimeout(\"location.href = 'http://malangmncplay.esy.es/that.php';\",500);</script>";    
        }
        else {
          echo '<script type="text/javascript">'; 
    ...
    function edit_data ($tiang, $id_fat , $noport , $id_port, $status, $no){
        ...
        if ($result){
            ...
            echo '</script>';
            echo "<script>setTimeout(\"location.href = 'http://malangmncplay.esy.es/that.php';\",1000);</script>";
        }
        else {
          echo '<script type="text/javascript">'; 
